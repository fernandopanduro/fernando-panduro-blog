...
import imgJpg from '../../pictures/img/adiccion-drogas2.jpg'
import imgWebp from '../../pictures/img/adiccion-drogas2.webp'
import imgAvif from '../../pictures/img/adiccion-drogas2.avif'

import imgJpg2 from '../../pictures/img/adiccion.jpg'
import imgWebp2 from '../../pictures/img/adiccion.webp'
import imgAvif2 from '../../pictures/img/adiccion.avif'
  ...
  return (
    <div className={`${styles.containerBlogs} flex container`}>
        ...
        <div className={`${styles.blogs} flex`}>
          ...
          <p>¿Dolores de abstinencia? ¡Eso es solo una ilusión! Muchas veces, los dolores son más mentales que físicos. La duda y la falta de certeza crean esas molestias. Así que, mantén la convicción de que estás haciendo lo correcto y los dolores desaparecerán como por arte de magia.</p>
          <h3 className='text-left'>Las instrucciones para liberarte de tu adiccion:</h3>
          <p>Sigue todas las instrucciones.</p>
          <ul>
